...
class CreateUpdatePropertyRequest extends FormRequest
{
    use HandleResponse;
    ...
    public function rules()
    {
        return [
            ...
            'property_type' => 'required|string|in:house,villa,apartment,land,commercial,office',
            'type' => 'required|string|in:sale,rent',
            'purpose' => 'required|string|in:residential,commercial',

            'bedrooms' => 'required|integer|min:1|max:20',
            'bathrooms' => 'required|integer|min:1|max:15',
            'living_rooms' => 'required|integer|min:0|max:10',
            'kitchens' => 'required|integer|min:1|max:5',
            'balconies' => 'required|integer|min:0|max:10',

            'area_total' => 'required|string|max:100000',
    ...
    public function messages()
    {
        return [
            ...
            'floor.max' => 'رقم الطابق لا يمكن أن يتجاوز 200.',
            ...
            'images.*.mimes' => 'الصورة يجب أن تكون من الأنواع: jpeg, jpg, png, gif, webp, svg',
            ...
            'videos.*.mimes' => 'الفيديو يجب أن يكون من الأنواع: mp4, avi, wmv, flv, webm',
            'videos.*.max' => 'يجب ألا يتجاوز حجم الفيديو 5 ميجابايت',
